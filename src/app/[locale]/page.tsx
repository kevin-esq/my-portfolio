          ...
          <div className="relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <div className="modern-card p-6 text-center group hover:scale-105 transition-transform duration-200">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Fast Development</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Modern tools and practices for rapid delivery</p>
              </div>
              ...
              <div className="modern-card p-6 text-center group hover:scale-105 transition-transform duration-200">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Beautiful Design</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">User-centered interfaces with attention to detail</p>
              </div>
              ...
              <div className="modern-card p-6 text-center group hover:scale-105 transition-transform duration-200">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">High Performance</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Optimized applications for best user experience</p>
              </div>
            </div>
          </div>
        </div>
